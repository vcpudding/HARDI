function [TensorODF W]=Estimate_tensorODF(S,S0,GradientOrientations,order,delta)
...
%BG=constructMatrixOfIntegrals_2562_1(1,GradientOrientations, order, delta);
BG=constructMatrixOfIntegrals_2562(GradientOrientations, order, delta);
P=BG*C;
%P=-G*C;
...
if order==4
    W=convertD2W(TensorODF([15 5 1 12 3 10 11 8 7 14 13 9 4 6 2]));
elseif order==6
