...
noisyImg = simulateCrossingFibers([16,16,3], 4, 1500, 10);
...
%load('SimData/ODF_SNR=50.mat');
save('../../Data/SimData/ODF_SNR=10.mat', 'noisyODF');
...
filteredODF_coef = reshape(filteredODF_coef, [16 16 3 15]);
